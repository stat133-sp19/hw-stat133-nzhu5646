...
5. For the filling mixture, place bread scraps in large bowl 
and pour milk over them

6. Let them sit gently for a couple of minutes before mashing 
them with a spoon so that a paste forms

7. Mix the mashed bread scraps with sausage meat, herbs, 
parmesan, and a pinch of salt and black pepper

8. Lay cabbage leaf on counter and form some of the filling 
mixture into a golf ball-sized clump

9. Wrap cabbage leaf around this clump and pin it with a 
toothpick

10. Repeat this for all the cabbage leaves

11. To make sauce, roughly chop tomatoes and cook them in a 
heavy saute pan with olive oil over medium heat
...
$\lVert \mathbf{p} \rVert = \sqrt{p_1^2 + p_2^2 + ... + p_n^2} =  \sqrt{\mathbf{p} \cdot \mathbf{p}})$, 
